...
-- JSON version of country region view
CREATE OR REPLACE VIEW views.country_region_json AS
SELECT CASE
       WHEN NOT cr.country_has_regions
       THEN jsonb_build_object(
               'id', cr.country_id
              ,'name', cr.country_name
              ,'code2',cr.country_code_2
              ,'code3', cr.country_code_3
              ,'hasRegions', false
       ...
       END
  FROM views.country_region cr
 GROUP BY cr.country_id
         ,cr.country_name
         ,cr.country_code_2
         ,cr.country_code_3
         ,cr.country_has_regions
